...
$.extend(DG.OnOffSwitch.prototype, {
    ...
    renderThumb: function () {
        ...
        var customBorderRadius = '50%';


        this.thumb = $('<div class="on-off-switch-thumb" style="width:' + 11 + 'px;height:' + 11 + 'px;top:2px"></div>');
        ...
        this.thumbColor = $('<div class="on-off-switch-thumb-color" style="border-radius:' + customBorderRadius + ';width:' + customSize + 'px;height:' + customSize +
